...

            {
                list.length === 0 ? (
                    ...
                    searchHistory.map((v, i) => (
                        <div className="flex gap-2 pt-2 pl-5 items-center text-[#c58af9]  cursor-pointer" key={i} onClick={() => ClickedSuggestion(v)} >
                    ...
                    list.map((v, i) => (
                        <div className="text-white flex gap-2 pt-2 pl-5 items-center cursor-pointer" key={i} onClick={() => ClickedSuggestion(v)}>
