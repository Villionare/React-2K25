        ...
        <div className="flex flex-col gap-2">
            ...
            {list.length === 0 ? (
                ...
                searchHistory.map((v, i) => (
                    <div className="flex gap-2 pt-2 pl-5 items-center text-[#c58af9]" key={i} onClick={(v) => ClickedSuggestion(v)}>
                        ...
                        <a href={`https://www.google.com/search?q=${v}`}>
                            {v}
                        </a>
                    </div>
                ))
                ...
                list.map((v, i) => (
                    <div className="text-white flex gap-2 pt-2 pl-5 items-center" key={i} onClick={(v) => ClickedSuggestion(v)}>
